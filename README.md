...
| ------------- | -----------------  |
| 12.22.11       | 12.22.11-alpine3.15 |
| 14.19.1       | 14.19.1-alpine3.15 |
| 16.14.2       | 16.14.2-alpine3.15 |
...
i.e. `./bump 16.13.0:16.14.2 14.18.1:14.19.1` will replace all instances of `16.13.0` with `16.14.2` and all instances of `14.18.1` with `14.19.1`.
