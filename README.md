...
| 16.16.0       | 16.16.0-alpine3.16 |
| 18.6.0        | 18.6.0-alpine3.16  |
...
i.e. `./bump 16.13.0:16.16.0 14.18.1:14.20.0` will replace all instances of `16.13.0` with `16.16.0` and all instances of `14.18.1` with `14.20.0`.
