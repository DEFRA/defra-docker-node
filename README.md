...
| ------------- | -----------------  |
| 14.19.2       | 14.19.2-alpine3.15 |
| 16.15.0       | 16.15.0-alpine3.15 |
| 18.1.0        | 18.1.0-alpine3.15  |
...
i.e. `./bump 16.13.0:16.15.0 14.18.1:14.19.2` will replace all instances of `16.13.0` with `16.15.0` and all instances of `14.18.1` with `14.19.2`.
